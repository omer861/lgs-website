...
import saasmendix from "../images/saasmendix.webp";
import saasawslogo from "../images/saasawslogo.webp";
import saasazurelogo from "../images/saasazurelogo.webp";
import saasopenshiftogo from "../images/saasopenshiftogo.webp";
import saassap from "../images/saassap.webp";
            ...
            <div className="row p-5 saas-reval ">
              <div className="col-12 col-md-6 saas-content">
                ...
                <p className="saas-card-para">
                  ...
                  Software as a Service (SaaS) platform, empowering businesses
                ...
                <p className="saas-card-para">
                  Unlock the full potential of your business with Labyrinth
                  Global Solutions. Sign up today for a free trial and discover
                  how our SaaS platform can take your business to new heights.
                </p>
                <div>
                  <Link to="/contactus">
